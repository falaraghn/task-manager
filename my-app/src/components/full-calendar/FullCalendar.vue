    ...
    <div class="comp-full-calendar">
        ...
        <fc-header :current-month="currentMonth"
            ...
            <div slot="header-left">
               <slot-scope name="fc-header-left">
               </slot-scope>
            </div>

            <div slot="header-right">
               <slot-scope name="fc-header-right">
               </slot-scope>
            </div>
        </fc-header>
        ...
        <div class="full-calendar-body">
            ...
            <div class="dates" ref="dates">
              ...
              'not-cur-month' : !day.isCurMonth}" @click.stop="dayClick(day.date, $event)">
                            <p class="day-number">{{day.monthDay}}</p>
                            <div class="event-box">
                                <event-card :event="event" :date="day.date" :firstDay="firstDay" v-for="event in day.events" :key="event.id" v-show="event.cellIndex <= eventLimit" @click="eventClick">
                                    <template scope="p">
                                        <slot-scope name="fc-event-card" :event="p.event"></slot-scope>
                                    </template>
                                </event-card>
                ...
                <div class="more-events" v-show="showMore"
                    ...
                    <div class="more-body">
                        <ul class="body-list">
                            <li v-for="event in selectDay.events" :key="event.id"
        ...
        methods : {
            ...
            slotEvents (date) {
                ...
                let thisDayEvents = this.events.filter(day => {
                    let st = moment(day.startDate);
                    let ed = moment(day.endDate ? day.endDate : st);
